<template>
      <div class="col p-5 m-2 text-center">
      want more features?
      <div class="d-flex">
    ...
    <div class="row m-2">
        ...
        <div class="card-body">
          ...
          <div class="aligner-wrapper">
            ...
            <canvas
              height="79"
              width="158"
              style="display: block; width: 158px; height: 79px"
              class="chartjs-render-monitor"
            ></canvas>
            <div class="absolute center-content">
              <h5
                class="font-weight-normal text-whiite text-center mb-2 text-white"
              >
                1200
              </h5>
      ...
      <div class="col col-7 p-5 m-2 stats">
        <div class="card-body">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="d-flex">
                          <img
                            src="/demo/corona-react-free/template/demo_1/preview/static/media/face1.42d41e61.jpg"
                            alt="face"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex">
                          <img
                            src="/demo/corona-react-free/template/demo_1/preview/static/media/face2.7e0e382d.jpg"
                            alt="face"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex">
                          <img
                            src="/demo/corona-react-free/template/demo_1/preview/static/media/face5.d2417284.jpg"
                            alt="face"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex">
                          <img
                            src="/demo/corona-react-free/template/demo_1/preview/static/media/face3.16c67435.jpg"
                            alt="face"
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex">
                          <img
                            src="/demo/corona-react-free/template/demo_1/preview/static/media/face4.d5afaa66.jpg"
                            alt="face"
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <div class="dashboard-vector-map">
              <div
                class="jvectormap-container"
                style="background-color: transparent"
              >
                <svg width="478.234" height="300">
                  <defs></defs>
                  <g
                    transform="scale(0.531371111111111) translate(5.348749458918356e-14, 61.93543138671688)"
                  >
                    <g>
                      <path
    ...
    <div class="stats text-center">
      ...
      <div class="card-footer text-body-secondary">
        <p>Experience the extraordinary journey of discovery and innovation.</p>
